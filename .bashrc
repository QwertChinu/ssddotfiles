...
alias upkg="yay -Syyy && updblocks 36"
alias updm="sudo reflector --verbose --latest 10 --protocol http --protocol https --sort rate --save /etc/pacman.d/mirrorlist && upkg"
alias upd="updm && yay -Qqe > ~/.local/bin/pkg && cfg commit -am 'Arch System update' && cfg push ; pass git push ;rsync -aAXv /home/chinu/.password-store/ /home/chinu/Dropbox/Secure/ps/ && bkp && yay -Syu && sudo journalctl --vacuum-time=2d && yay -Sc && sudo fstrim -a -v && updblocks 36 && updblocks 37 && updblocks 38"
alias r="ranger"
...
alias play="mpv ~/Downloads/video/Mood\ Music\ –\ 20\ Soft\ Bollywood\ Instrumentals\ _\ Jukebox-pJAXt1D68IE.webm"

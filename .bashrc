...
alias upd="updm && yay -Qqe > ~/.local/bin/pkg && cfg commit -am 'Arch System update' && cfg push ; bkp && yay -Syu && sudo journalctl --vacuum-time=2d && yay -Sc && sudo fstrim -a -v && updblocks 36 && updblocks 37 && updblocks 38"
alias r="ranger"

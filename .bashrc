...
alias upd="updm && sudo fstrim -a -v && yay -Qqe > ~/.local/bin/pkg && cfg commit -am 'Arch System update' && cfg push ; bkp && yay -Syu && sudo journalctl --vacuum-time=2d && yay -Sc && updblocks 36 && updblocks 37 && updblocks 38"
alias r="ranger"
